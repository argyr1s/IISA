...
<div class="well">
  <table class="table" width="100%">
    ...
    <tbody>
      <?php
		$SQL_AUSER = mysql_query("SELECT * FROM `tbl_topic_content`");
						  ...
						  $pages->mid_range = 9;  
							  ...
							  $SQL_AUSER1 = mysql_query("SELECT * FROM `tbl_topic_content` ".$pages->limit);
      ...
      <tr>
        <td><?php echo $i; ?></td>
        <td><?=$GET_ROW['topic_name'];?></td>
        <td><a href="index.php?action=editTopicContent&id=<?php echo $GET_ROW['id'];?>" title="Edit"><i class="icon-pencil"></i></a> &nbsp; </td>
      </tr>
      <?php
