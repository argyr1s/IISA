<div class="content">
<div class="header">
  <h1 class="page-title">Schedule Day</h1>
</div>
<ul class="breadcrumb">
  <li><a href="index.php">Home</a> <span class="divider">/</span></li>
  <li class="active">Schedule Day</li>
</ul>
...
<div class="well">
  <table class="table" width="100%">
    <thead>
      <tr>
        <th width="18">#</th>
        <th width="104">Topic Name</th>
        <th width="43" style="width: 26px;">Action</th>
      </tr>
    </thead>
    <tbody>
      <?php
		$SQL_AUSER = mysql_query("SELECT * FROM `tbl_schedule_day`");
						  ...
						  $pages->mid_range = 9;  
							  ...
							  $SQL_AUSER1 = mysql_query("SELECT * FROM `tbl_schedule_day` ".$pages->limit);
      ...
      <tr>
        <td><?php echo $i; ?></td>
        <td><?=$GET_ROW['day'];?></td>
        <td><a href="index.php?action=editScheduleDay&id=<?php echo $GET_ROW['id'];?>" title="Edit"><i class="icon-pencil"></i></a> &nbsp; </td>
      </tr>
      <?php
