...
class CKFinder_Connector_Core_Config
{
     ...
     * @access private
     */
    private $_secureImageupload = true;
    /**
    ...
    /**
	 * Get "secureImageupload" value
	 *
	 * @access public
	 * @return boolean
	 */
    public function getSecureImageupload()
    {
        return $this->_secureImageupload;
    }
	...
	*/
    ...
    private function loadValues()
    {
        ...
        if (isset($GLOBALS['config']['SecureImageupload'])) {
            $this->_secureImageupload = CKFinder_Connector_Utils_Misc::booleanValue($GLOBALS['config']['SecureImageupload']);
        }
