...
<div class="well">
  <table class="table" width="100%">
    <thead>
      <tr>
        <th width="18">#</th>
        <th width="104">Latitude</th>
        <th width="104">Logitude</th>
        <th width="43" style="width: 26px;">Action</th>
      </tr>
    </thead>
    <tbody>
      <?php
		$SQL_AUSER = mysql_query("SELECT * FROM `tbl_map`");
						  ...
						  $pages->mid_range = 9;  
							  ...
							  $SQL_AUSER1 = mysql_query("SELECT * FROM `tbl_map` ".$pages->limit);
      ...
      <tr>
        ...
        <td><?=$GET_ROW['lat'];?></td>
        <td><?=$GET_ROW['long'];?></td>
        <td><a href="index.php?action=editMap&id=<?php echo $GET_ROW['id'];?>" title="Edit"><i class="icon-pencil"></i></a></td>
      </tr>
      <?php
