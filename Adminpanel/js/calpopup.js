...
var cp_timeoutDelay = 20; 	// milliseconds, change this if you like, set to 0 for the calendar to never auto disappear
...
Calendar.prototype.clickDay = function(day){
    ...
    document.getElementById(field).className = "text-box2cal";
