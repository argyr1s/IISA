...
/**
 * @fileOverview The "filebrowser" plugin, it adds support for file upload and
 *               browsing.
 *
 ...
 * 	id : 'uploadButton',
 * 	filebrowser : 'tabId:elementId',
 * 	label : editor.lang.common.uploadubmit,
 * 	'for' : [ 'upload', 'upload' ]
 * }
 * </pre>
 *
...
/**
 * The location of a script that handles file upload.
...
/**
 * The location of a script that handles file upload in the Image dialog.
...
/**
 * The location of a script that handles file upload in the Flash dialog.
 * If not set, CKEditor will use {@link CKEDITOR.config.filebrowserUploadUrl}.
